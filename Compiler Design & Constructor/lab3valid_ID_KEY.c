...
#include<stdio.h>
#include<string.h>
char keyword[32][10]= { "auto","double","int","struct","break","else","long","switch",
...
ch = string[i];
if(iskeyword(string))
 printf("The string %s is keyword.",string);
else 
{
while(ch!='\0')
{
...
if(curr_state==qf)
 printf("The string %s is valid indentifier.",string);
else 
 printf("The string %s is neither keyword nor valid identifier.",string);
 }
return 0;
} //end of the main
//transition function
